    ...
    >
      <div className="max-w-[1400px] mx-auto grid grid-cols-1 md:grid-cols-12 gap-10 md:gap-16">
        ...
        <div className="md:col-span-9">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-14 gap-y-6 text-[15px] text-foreground/70 leading-[1.85] max-w-4xl">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {techniques.map((t) => (
                <div key={t.label}>
                  ...
                  <p className="text-[13px] text-muted-foreground leading-[1.7]">{t.hint}</p>
                </div>
              ))}
            </div>
          </div>
