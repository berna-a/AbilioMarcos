  ...
  return (
    ...
    >
      <div className="flex items-baseline justify-between mb-12 pb-3 border-b border-gallery-border">
        <p className="text-[12px] tracking-[0.3em] uppercase text-foreground">
          {t.aboutPage.trajectoryTitle}
        </p>
        <p className="text-[13px] tracking-[0.18em] uppercase text-foreground hidden md:block">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-px bg-gallery-border">
        {items.map((it) => (
          <div key={it.label} className="bg-background p-8 md:p-10">
            ...
            <p className="text-[14px] tracking-[0.12em] uppercase text-foreground leading-[1.6]">
              {it.label}
            </p>
          </div>
        ))}
      ...
      <p className="mt-10 max-w-2xl text-[14.5px] text-foreground leading-[1.85]">
