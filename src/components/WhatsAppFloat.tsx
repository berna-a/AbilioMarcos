  ...
  return (
    <AnimatePresence>
      {scrolled && (
        ...
        >
          <span className="hidden md:flex items-center pr-3 pl-4 py-2.5 mr-[-14px] text-[13px] tracking-[0.15em] uppercase bg-background/95 border border-border text-foreground opacity-0 translate-x-2 group-hover:opacity-100 group-hover:translate-x-0 transition-all duration-300 shadow-sm rounded-l-full">
