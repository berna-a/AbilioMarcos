    ...
    <AnimatePresence>
      {scrolled && (
        ...
        >
          ...
          <span className="relative flex items-center justify-center w-12 h-12 md:w-[52px] md:h-[52px] rounded-full bg-foreground text-background shadow-lg hover:bg-brand-red transition-colors duration-300 ring-1 ring-black/5">
