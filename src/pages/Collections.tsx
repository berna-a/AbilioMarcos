    ...
    <Layout>
      <div className="pt-24 md:pt-32 pb-20 md:pb-30 px-6 md:px-10">
        <div className="max-w-[1400px] mx-auto">
          ...
          >
            <p className="text-xs tracking-[0.2em] uppercase text-muted-foreground mb-4">Bodies of Work</p>
            <h1 className="font-serif text-3xl md:text-4xl lg:text-5xl font-light">Collections</h1>
          </motion.div>
                ...
                <Link to={`/collections/${collection.id}`} className="group block">
                  ...
                  <div className="mt-4">
                    ...
                    <p className="text-xs text-muted-foreground mt-1">
                      {collection.count} works · {collection.year}
                    </p>
                  </div>
                </Link>
              </motion.div>
